...
<div class="col-12 ">
    <div class="row justify-content-center">
        <form id="khachhang" class="col-12" method="post" action=" {{ route('khachhang.update', $khachhang['id']) }}">
            @csrf
        <div class="col-sm-12" style="background-color: #ffff">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" value="{{ $khachhang['hoten'] }}" name="name" placeholder="Ho Ten">
                </div>
                @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="birthday" value="{{ $khachhang['ngaysinh'] }}" name="birthday" placeholder="Ngay sinh">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="address" name="address" value="{{ $khachhang['diachi'] }} " placeholder="Dia chi">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="address_2" id="address_2" value="{{ $khachhang['diachitt'] }}" placeholder="Dia chi thuong tru">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="cmnd" value="{{ $khachhang['cmnd'] }}" name="cmnd" minlength="9" maxlength="9"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="phone" value="{{ $khachhang['sdt'] }}" name="phone" minlength="10" maxlength="12"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" value="{{ $khachhang['email'] }}" name="email" placeholder="Email">
                </div>
                @if ($errors->has('email'))
                <div class="error">{{ $errors->first('cmnd') }}</div>
                @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea name="mo_ta" id="mo_ta"  name="mo_ta" cols="90" rows="10">{{ $khachhang['mota'] }}</textarea>
                </div>
                @if ($errors->has('mo_ta'))
