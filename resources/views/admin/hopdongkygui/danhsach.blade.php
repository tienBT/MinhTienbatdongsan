                                ...
                                <tbody>
                                   @foreach($danhsach as $ds)
                                      <tr>
                                          ...
                                          <td>{{$ds->trangthai}}</td>
                                          <td>
                                              <a class="update glyphicon glyphicon-edit" href="admin/hopdongkygui/sua/{{$ds->id}}"></a>
                                              <a class="delete glyphicon glyphicon-remove-sign" href="admin/hopdongkygui/xoa/{{$ds->id}}"></a>
                                          </td>
                                      </tr>
                                   @endforeach
                                </tbody>
