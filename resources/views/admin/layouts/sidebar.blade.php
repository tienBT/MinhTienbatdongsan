<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu" >
			...
			<li id="menu-academico" ><a href="admin/user/danhsach"><i class="fa fa-user"></i><span>Quản lí nhân viên</span><div class="clearfix"></div></a></li>
			...
			<li id="menu-academico" ><a href="admin/loaibatdongsan/danhsach"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Loại Bất Động Sản</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
				<ul id="menu-academico-sub" >
					<li id="menu-academico-avaliacoes" ><a href="admin/loaibatdongsan/them">Thêm</a></li>
					<li id="menu-academico-avaliacoes" ><a href="typography.html">Typography</a></li>
					<li id="menu-academico-avaliacoes" ><a href="faq.html">Faq</a></li>
				</ul>
			</li>
			<li id="menu-academico" ><a href="admin/batdongsan/danhsach"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Bất Động Sản</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
				<ul id="menu-academico-sub" >
					<li id="menu-academico-avaliacoes" ><a href="admin/batdongsan/them">Thêm</a></li>
					<li id="menu-academico-avaliacoes" ><a href="typography.html">Typography</a></li>
					<li id="menu-academico-avaliacoes" ><a href="faq.html">Faq</a></li>
				</ul>
			</li>
			...
			<li id="menu-academico-khachhang" ><a href="{{ route('khachhang.index') }}"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Qlý Khách Hàng</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
				<ul id="menu-academico-sub" >
					<li id="menu-academico-avaliacoes" ><a href="">Thêm</a></li>
					<li id="menu-academico-avaliacoes" ><a href="">Tra cứu</a></li>
				</ul>
			</li>
